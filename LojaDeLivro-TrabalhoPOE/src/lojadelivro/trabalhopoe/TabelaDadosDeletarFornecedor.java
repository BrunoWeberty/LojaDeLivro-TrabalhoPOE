...
public class TabelaDadosDeletarFornecedor extends JFrame
{
    private JTable tabela;

    public TabelaDadosDeletarFornecedor(ArrayList<String> fornecedores) 
    {
        ...
        Object dados[][] = new Object[(fornecedores.size())+50][9];
        ...
        public void mouseClicked(MouseEvent e) 
        {
            ...
            if(e.getClickCount() == 1)
            {
                ...
                if(resposta == 0)
                {
                   ...
                   boolean status = acessoArquivo.deletarLinhaArquivo(identificadorLinha, "arquivoFornecedores.txt");
                   if(status)
                   {
